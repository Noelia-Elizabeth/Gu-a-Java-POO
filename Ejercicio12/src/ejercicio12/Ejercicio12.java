...
Ejemplo Date como atributo: DateAtributo
    ...
    • Agregar un método de creación del objeto que respete la siguiente firma: crearPersona(). 
      ...
      la fecha de nacimiento de la persona a crear, recordemos que la fecha de nacimiento debe guardarse en un Date y 
    ...
    • Agregar a la clase el método menorQue(int edad) que recibe como parámetro otra edad y 
      retorna true en caso de que el receptor tenga menor edad que la persona que se recibe como parámetro, 
...
public class Ejercicio12 {
    ...
    public static void main(String[] args) {
        ...
        noelia.crearPersona();
        System.out.println("La edad de " + noelia.getNombre() + " es: " + noelia.calcularEdad());
        System.out.println("¿Tiene menos de 19 años? " + noelia.menorQue(19));
        noelia.mostrarPersona();
