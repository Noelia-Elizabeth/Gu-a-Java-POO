...
siendo cada x e y un punto. Generar un objeto puntos usando un método crearPuntos() que le pide al usuario
...
public class Extra2 {
    ...
    public static void main(String[] args) {
        ...
        Puntos parDePuntos = new Puntos();
        
        parDePuntos.crearPuntos();
        
        System.out.println("La distancia entre los puntos es: " + parDePuntos.calcularDistancia());
