...
Luego, las operaciones que se podrán realizar son las siguientes:
    ...
    • Método calcular(): esté método llamará tieneRaices() y a tieneRaíz(), y 
      mostrará por pantalla las posibles soluciones que tiene nuestra ecuación con los métodos obtenerRaices() o obtenerRaiz(), 
...
public class Extra3 {
    ...
    public static void main(String[] args) {
        ...
        Raices raices = new Raices(8.0,0.0,2.0); //No tiene soluciones reales.
